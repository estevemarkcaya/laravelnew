...
<header>
    <div class="container">
        <nav class="navbar navbar-expand-lg" style="background-color: #e3f2fd;">
            <a class="navbar-brand" href="/">
                <img src="LOGO2.webp" alt="LOGO2.webp" class="logo" style="width:80px;">
            </a>
    ...
    <section class="about-us">
        <div class="steve1" id="about">
            <h2>About Us</h2>
            <div class="about-content">
                <p>Welcome to MarkHub, where innovation meets excellence. Our mission is to provide...</p>
                <p>Founded in 2021, MarkHub has been dedicated to strive hard.</p>
            </div>
            <div class="team">
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-logo">
                    <img src="LOGO2.webp" alt="MarkHub Footer Logo">
                </div>
